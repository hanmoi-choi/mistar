...
Ext.define('MIStar.view.system.Desktop', {
    extend: 'Ext.panel.Panel',

    alias: 'widget.desktop-view',
    ...
    uses: [
        ...
        'MIStar.view.system.TaskBar',
        'MIStar.view.system.Wallpaper',
        'MIStar.view.system.FitAllLayout'
    ],
    ...
    initComponent: function () {
        ...
        me.bbar = me.taskbar = new MIStar.view.system.TaskBar(me.taskbarConfig);

        me.taskbar.windowMenu = me.windowMenu;

        me.windows = new Ext.util.MixedCollection();

        me.contextMenu = new Ext.menu.Menu(me.createContextDesktopMenu());
...
//        me.el.on('contextmenu', me.onDesktopMenu, me);
    ...
    createContextDesktopMenu: function () {
        var me = this, ret = {
    ...
    onShortcutItemClick: function (dataView, record) {
        var me = this, module = me.app.getModule(record.data.id),
...
//    createWindow: function(config, cls) {
    createWindow: function(moduleView) {
        var me = this, cls, win, cfg = Ext.apply(moduleView, {
            stateful: false,
            isWindow: true,
