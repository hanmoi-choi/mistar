 ...
 */
Ext.define('MIStar.view.system.Settings',{
    extend: 'Ext.window.Window',
    alias: 'widget.settings-view',
    ...
    createTree : function() {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: 'MIStar.model.system.Wallpaper',
                root: {
                    text:'Wallpaper',
                    expanded: true,
                    children:[
    ...
    onSelect: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = MIStar.Constant.WALLPAPER_IMAGE_PATH + record.data.img;
        } else {
    ...
    setInitialSelection: function () {
        ...
        if (s) {
            var path = MIStar.Constant.WALLPAPER_IMAGE_PATH + this.getTextOfWallpaper(s);
